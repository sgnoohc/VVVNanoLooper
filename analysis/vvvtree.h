...
// makeCMS3ClassFiles("/home/users/phchang/work/wwz/VVVNanoLooper_/WWZJets_2017.root", "t", "vvvtree", "tas", "vvv")
...
class vvvtree {
 ...
 protected: 
  ...
  bool     Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_;
  TBranch *Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_branch;
  bool     Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_isLoaded;
  bool     Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_;
  TBranch *Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_branch;
  bool     Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_isLoaded;
  ...
  bool     Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_;
  TBranch *Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_branch;
  bool     Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_isLoaded;
  bool     Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_;
  TBranch *Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_branch;
  bool     Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_isLoaded;
  ...
  bool     Common_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_;
  TBranch *Common_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_branch;
  bool     Common_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8_isLoaded;
  ...
  vector<int> *Common_tau_idxs_;
  TBranch *Common_tau_idxs_branch;
  bool     Common_tau_idxs_isLoaded;
  vector<int> *Common_tau_decayMode_;
  TBranch *Common_tau_decayMode_branch;
  bool     Common_tau_decayMode_isLoaded;
  vector<float> *Common_tau_dxy_;
  TBranch *Common_tau_dxy_branch;
  bool     Common_tau_dxy_isLoaded;
  vector<float> *Common_tau_dz_;
  TBranch *Common_tau_dz_branch;
  bool     Common_tau_dz_isLoaded;
  vector<float> *Common_tau_eta_;
  TBranch *Common_tau_eta_branch;
  bool     Common_tau_eta_isLoaded;
  vector<float> *Common_tau_chargedIso_;
  TBranch *Common_tau_chargedIso_branch;
  bool     Common_tau_chargedIso_isLoaded;
  vector<int> *Common_tau_jetIdx_;
  TBranch *Common_tau_jetIdx_branch;
  bool     Common_tau_jetIdx_isLoaded;
  vector<float> *Common_tau_neutralIso_;
  TBranch *Common_tau_neutralIso_branch;
  bool     Common_tau_neutralIso_isLoaded;
  vector<int> *Common_tau_charge_;
  TBranch *Common_tau_charge_branch;
  bool     Common_tau_charge_isLoaded;
  ...
  vector<int> *Common_GenVisTau_idxs_;
  TBranch *Common_GenVisTau_idxs_branch;
  bool     Common_GenVisTau_idxs_isLoaded;
  vector<int> *Common_GenVisTau_status_;
  TBranch *Common_GenVisTau_status_branch;
  bool     Common_GenVisTau_status_isLoaded;
...
void LoadAllBranches(); 
  ...
  const bool &Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL();
  const bool &Common_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ();
  const bool &Common_HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ();
  const bool &Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ();
  const bool &Common_HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL();
  ...
  const bool &Common_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8();
  ...
  const vector<int> &Common_tau_idxs();
  const vector<int> &Common_tau_decayMode();
  const vector<float> &Common_tau_dxy();
  const vector<float> &Common_tau_dz();
  const vector<float> &Common_tau_eta();
  const vector<float> &Common_tau_chargedIso();
  const vector<int> &Common_tau_jetIdx();
  const vector<float> &Common_tau_neutralIso();
  const vector<int> &Common_tau_charge();
  ...
  const vector<int> &Common_GenVisTau_idxs();
  const vector<int> &Common_GenVisTau_status();
