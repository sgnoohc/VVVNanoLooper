...
void Process_2LepRun3()
{
    Process_2LepRun3_NanoAOD();
}

void Process_2LepRun3_NanoAOD()
{
    //==============================================
    // Process_2LepRun3:
    // This function gets called during the event looping.
    // This is where one sets the variables used for the category 2LepRun3.
    //==============================================
...
void PostProcess_2LepRun3()
{
    ...
    if (ana.cutflow.getCut("Cut_2LepRun3_Preselection").pass)
    {
        ana.tx.fill();
    }
