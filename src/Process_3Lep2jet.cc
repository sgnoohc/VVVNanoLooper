...
void Process_3Lep2jet()
{
    //==============================================
    // Process_3Lep2jet:
    // This function gets called during the event looping.
    // This is where one sets the variables used for the category 3Lep2jet.
    //==============================================
    ...
    ana.tx.setBranch<float>("3Lep2jet_intVar1", -999);
    ana.tx.setBranch<float>("3Lep2jet_floatVar1", -999);
    ...
    LorentzVector LV_3Lep2jet_LVVar1 = RooUtil::Calc::getLV(34.5, 1.2, 3.123, 0.105); // RooUtil::Calc::getLV() creates 4 vector

    ana.tx.setBranch<LorentzVector>("3Lep2jet_LVVar1", LV_3Lep2jet_LVVar1);
}
