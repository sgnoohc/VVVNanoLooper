...
void Begin_allHad_NanoAOD()
{
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_trigger",
                                      [&]() {
                                          ...
                                          if ((ana.tx.getBranchLazy<int>("Common_year") == 2018 || ana.tx.getBranchLazy<int>("Common_year") == 2017) && (ana.tx.getBranchLazy<bool>("Common_HLT_PFHT1050") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet500") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet360_TrimMass30") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet380_TrimMass30") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet400_TrimMass30") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet420_TrimMass30") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFHT750_TrimMass50") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFHT800_TrimMass50") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFHT850_TrimMass50") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFHT900_TrimMass50")))
                                          {

                                              return true;
                                          }

                                          if ((ana.tx.getBranchLazy<int>("Common_year") == 2016) && (ana.tx.getBranchLazy<bool>("Common_HLT_PFHT650_WideJetMJJ900DEtaJJ1p5") || ana.tx.getBranchLazy<bool>("Common_HLT_PFHT650_WideJetMJJ950DEtaJJ1p5") || ana.tx.getBranchLazy<bool>("Common_HLT_PFHT800") || ana.tx.getBranchLazy<bool>("Common_HLT_PFHT900") || ana.tx.getBranchLazy<bool>("Common_HLT_PFJet450") || ana.tx.getBranchLazy<bool>("Common_HLT_PFJet500") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet450") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet500") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFJet360_TrimMass30") || ana.tx.getBranchLazy<bool>("Common_HLT_AK8PFHT700_TrimR0p1PT0p03Mass50"))) return true;
...
void Begin_allHad_VVVTree_writeTree()
{
    ...
    // EFT Reweighting
    //~~~~~~~~~~~~~~~~
    ana.cutflow.addCutToLastActiveCut("allHad_EFT", UNITY /* no cuts */, [&, eft_reweighting_idx]() {
        // Default is weight = 1
        float wgt = 1.0;
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_preselection",
                                      [&]() {
                                          // Require HT cut
                                          if (not(ana.tx.getBranch<float>("allHad_HT") > 1100)) return false;
                                          return true;
                                      },
                                      UNITY);
...
void Begin_allHad_VVVTree()
{
                                      ...
                                      [&]() {
                                          ...
                                          for (unsigned int ij = 0; ij < ana.tx.getBranchLazy<vector<int>>("Common_fatjet_idxs").size(); ij++)
                                          {
                                              if (is_baseline_fatjet(ij, true, false))
                                              {
                                                  ...
                                                  LorentzVector tmp_SD = RooUtil::Calc::getLV(ana.tx.getBranchLazy<vector<LorentzVector>>("Common_fatjet_p4")[ij].Pt(), ana.tx.getBranchLazy<vector<LorentzVector>>("Common_fatjet_p4")[ij].Eta(), ana.tx.getBranchLazy<vector<LorentzVector>>("Common_fatjet_p4")[ij].Phi(), ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[ij]);
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_ORTrigger_2fj", [&]() { return true; }, [&]() { return 1; });
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_2fj_1med1tight",
                                      [&]() {
                                          ...
                                          if ((ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[0] == 3 && ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[1] == 2) || (ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[1] == 3 && ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[0] == 2)) return true;
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_2fj_ABCD_A",
                                      [&]() {
                                          ...
                                          if ((ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[0] >= 65. && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[0] <= 105.) && (ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[1] >= 65. && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[1] <= 105.)) return true;
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_2fj_ABCD_C",
                                      [&]() {
                                          ...
                                          if ((ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[0] >= 65. && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[0] <= 105.) && (ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[1] > 40. && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[1] < 65.)) return true;
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_2fj_ABCD_E",
                                      [&]() {
                                          ...
                                          if ((ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[0] >= 65. && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[0] <= 105.) && (ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[1] > 105. && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[1] < 150.)) return true;
    ...
    */
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_3fj_2tight1med",
                                      [&]() {
                                          ...
                                          for (unsigned int i = 0; i < 3; i++)
                                          {
                                              if (ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[i] == 3)
                                                  n_pass++;
                                              else if (ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[i] == 2)
                                                  n_fail++;
                                          }
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_3fj_atleastfailsomething",
                                      [&]() {
                                          ...
                                          for (unsigned int i = 0; i < 3; i++)
                                          {
                                              if (ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[i] == 3 && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[i] >= 65. && ana.tx.getBranchLazy<vector<float>>("Common_fatjet_msoftdrop")[i] < 105.)
                                                  n_pass++;
                                              else if (ana.tx.getBranchLazy<vector<int>>("Common_fatjet_WP_MD")[i] >= 2)
                                                  n_fail++;
                                          }
    ...
    ana.cutflow.addCutToLastActiveCut("allHad_3fj_atleastfailsomething_3rdsignal",
                                      [&]() {
                                          ...
                                          // want 3 at least medium, and at least 1 medium-not-tight
                                          if (n_pass + n_fail == 2 && n_fail >= 1 && signal3rd)
                                              return true;
                                          else
                                              return false;
                                      },
...
void Begin_1L_VVVTree()
{
    ...
    ana.cutflow.getCut("CommonCut");
    ana.cutflow.addCutToLastActiveCut("oneLep_EFT",
                                      [&, eft_reweighting_idx_1l]() {
                                          ana.tx.setBranch<float>("allHad_fj_mVVV_reco_nomet_SD", -999);
                                          ana.tx.setBranch<float>("allHad_fj_ptVVV_reco_nomet_SD", -999);
                                          ana.tx.setBranch<float>("allHad_HT", -999);
    ...
    ana.cutflow.addCutToLastActiveCut("oneLep_MuSF", [&]() { return true; }, [&]() { return ana.tx.getBranchLazy<vector<float>>("Common_lep_SF")[0]; });
    ...
    ana.cutflow.addCutToLastActiveCut("oneLep_ElSF", [&]() { return true; }, [&]() { return ana.tx.getBranchLazy<vector<float>>("Common_lep_SF")[0]; });
