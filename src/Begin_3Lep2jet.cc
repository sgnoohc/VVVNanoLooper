...
void Begin_3Lep2jet()
{
    ...
    RooUtil::Histograms 3Lep2jet_hists;
    3Lep2jet_hists.addHistogram("h_3Lep2jet_intVar1", 10, 0, 10, [&]() { return ana.tx.getBranch<int>("3Lep2jet_intVar1"); } );
    3Lep2jet_hists.addHistogram("h_3Lep2jet_floatVar1", 180, 0, 500, [&]() { return ana.tx.getBranch<float>("3Lep2jet_floatVar1"); } );
    3Lep2jet_hists.addHistogram("h_3Lep2jet_LVVar1_Pt", 180, 0, 150, [&]() { return ana.tx.getBranch<LorentzVector>("3Lep2jet_LVVar1").pt(); } );
    ...
    ana.cutflow.bookHistogramsForCut(3Lep2jet_hists, "3Lep2jet_Preselection");
}
