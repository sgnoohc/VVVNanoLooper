...
void Begin_3Lep2jet()
{
    ...
    ana.tx.createBranch<float>("3Lep2jet_intVar1");
    ...
    ana.histograms.addHistogram("h_3Lep2jet_intVar1", 10, 0, 10, [&]() { return ana.tx.getBranch<float>("3Lep2jet_intVar1"); } );
    ana.histograms.addHistogram("h_3Lep2jet_floatVar1", 180, 0, 500, [&]() { return ana.tx.getBranch<float>("3Lep2jet_floatVar1"); } );
    ana.histograms.addHistogram("h_3Lep2jet_LVVar1_Pt", 180, 0, 150, [&]() { return ana.tx.getBranch<LorentzVector>("3Lep2jet_LVVar1").pt(); } );
    ...
    ana.cutflow.bookHistogramsForCut(ana.histograms, "3Lep2jet_Preselection");
}
