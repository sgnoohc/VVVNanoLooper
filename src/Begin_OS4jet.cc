...
void Begin_OS4jet()
{
    ...
    ana.cutflow.addCutToLastActiveCut("Cut_OS4jet_Preselection", [&]() { return ana.tx.getBranch<LorentzVector>("OS4jet_LVVar1").pt() > 25.;}, [&]() { return ana.tx.getBranch<float>("OS4jet_floatVar1"); } );

    // Create histograms used in this category.
    // Please follow the convention of h_<category>_<varname> structure.
    // N.B. Using nbins of size 180 or 360 can provide flexibility as it can be rebinned easily, as 180, 360 are highly composite numbers.
    RooUtil::Histograms hists_OS4jet;
    hists_OS4jet.addHistogram("h_OS4jet_intVar1", 10, 0, 10, [&]() { return ana.tx.getBranch<int>("OS4jet_intVar1"); } );
    hists_OS4jet.addHistogram("h_OS4jet_floatVar1", 180, 0, 500, [&]() { return ana.tx.getBranch<float>("OS4jet_floatVar1"); } );
    hists_OS4jet.addHistogram("h_OS4jet_LVVar1_Pt", 180, 0, 150, [&]() { return ana.tx.getBranch<LorentzVector>("OS4jet_LVVar1").pt(); } );
