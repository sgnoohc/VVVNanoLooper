...
void Begin_3LepMET()
{
    ...
    RooUtil::Histograms 3LepMET_hists;
    3LepMET_hists.addHistogram("h_3LepMET_intVar1", 10, 0, 10, [&]() { return ana.tx.getBranch<int>("3LepMET_intVar1"); } );
    3LepMET_hists.addHistogram("h_3LepMET_floatVar1", 180, 0, 500, [&]() { return ana.tx.getBranch<float>("3LepMET_floatVar1"); } );
    3LepMET_hists.addHistogram("h_3LepMET_LVVar1_Pt", 180, 0, 150, [&]() { return ana.tx.getBranch<LorentzVector>("3LepMET_LVVar1").pt(); } );
    ...
    ana.cutflow.bookHistogramsForCut(3LepMET_hists, "3LepMET_Preselection");
}
