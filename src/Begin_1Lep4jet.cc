...
void Begin_1Lep4jet()
{
    ...
    ana.cutflow.addCutToLastActiveCut("Cut_1Lep4jet_DeepWProd", [&]() { return (nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] * nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]) > 0.5;}, UNITY);
    ...
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_eta_0", 180, -5, 5, [&]() { return ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[0].eta(); } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_eta_1", 180, -5, 5, [&]() { return ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[1].eta(); } );
    ...
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_MDdeepW_sum", 180, -1, 2, [&]() { return nt.FatJet_deepTagMD_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] + nt.FatJet_deepTagMD_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_MDdeepW_prod", 180, -1, 2, [&]() { return nt.FatJet_deepTagMD_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] * nt.FatJet_deepTagMD_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]; } );
    ...
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_deepW_sum", 180, -1, 2, [&]() { return nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] + nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_deepW_prod", 180, -1, 2, [&]() { return nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] * nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_deepW_prod_zoom", 180, 0.8, 1, [&]() { return nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] * nt.FatJet_deepTag_WvsQCD()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]; } );
    ...
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_tau_21_sum", 180, 0, 2, [&]() { return nt.FatJet_tau2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] / nt.FatJet_tau1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] + nt.FatJet_tau2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]] / nt.FatJet_tau1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_tau_21_prod", 180, 0, 1, [&]() { return nt.FatJet_tau2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] / nt.FatJet_tau1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] * nt.FatJet_tau2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]] / nt.FatJet_tau1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]; } );
    ...
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_subjet_ptfrac_0_0", 180, 0, 1, [&]() { if (nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] >= 0) return nt.Jet_pt()[nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]]] / ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[0].pt(); else return -999.f; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_subjet_ptfrac_1_0", 180, 0, 1, [&]() { if (nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] >= 0) return nt.Jet_pt()[nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]]] / ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[0].pt(); else return -999.f; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_subjet_ptfrac_0_1", 180, 0, 1, [&]() { if (nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]] >= 0) return nt.Jet_pt()[nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]] / ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[1].pt(); else return -999.f; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_subjet_ptfrac_1_1", 180, 0, 1, [&]() { if (nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]] >= 0) return nt.Jet_pt()[nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]] / ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[1].pt(); else return -999.f; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_subjet_pt_ratio_0", 180, -20, 10, [&]() { if (nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] >= 0 and nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]] >= 0) return nt.Jet_pt()[nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]]] / nt.Jet_pt()[nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[0]]]; else return -999.f; } );
    hists_1Lep4jet.addHistogram("h_1Lep4jet_fatjet_subjet_pt_ratio_1", 180, -20, 10, [&]() { if (nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]] >= 0 and nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]] >= 0) return nt.Jet_pt()[nt.FatJet_subJetIdx1()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]] / nt.Jet_pt()[nt.FatJet_subJetIdx2()[ana.tx.getBranch<vector<int>>("Common_fatjet_idxs")[1]]]; else return -999.f; } );
    ...
    hists_1Lep4jet.addHistogram("h_1Lep4jet_pt_lvJJ", 180, 0, 4000, [&]() { return (ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[0] + ana.tx.getBranch<vector<LorentzVector>>("Common_fatjet_p4")[1] + ana.tx.getBranch<LorentzVector>("1Lep4jet_lep_p4") + ana.tx.getBranch<LorentzVector>("Common_met_p4")).mass(); } );
    ...
    ana.cutflow.bookHistogramsForCut(hists_1Lep4jet, "Cut_1Lep4jet_FatJetMassPresel");
