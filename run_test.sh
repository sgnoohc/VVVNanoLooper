...
rm -rf .jobs.txt
echo "rm -rf debug_tt0.root; ./doVVVAnalysis -n 10000 -i ${TESTBKGTT0} -t Events -o debug_tt0.root -m 10 -w > debug_tt0.log 2>&1" >> .jobs.txt
echo "rm -rf debug_tt1.root; ./doVVVAnalysis -n 10000 -i ${TESTBKGTT1} -t Events -o debug_tt1.root -m 10 -w > debug_tt1.log 2>&1" >> .jobs.txt
echo "rm -rf debug_www.root; ./doVVVAnalysis -n 10000 -i ${TESTSIGWWW} -t Events -o debug_www.root -m 10 -w > debug_www.log 2>&1" >> .jobs.txt
