...
if __name__ == "__main__":
    ...
    sample_list = glob.glob(os.environ["skimDir"]+"/WWZJetsTo4L2Nu_4F_TuneCP5_13TeV-amcatnlo-pythia8_RunIISummer20UL17NanoAODv9*") # change the "*" to the sample names that you want to run over (currently runs over all skimmed samples)
